...
namespace Cobalt::Widgets
{
    ...
    auto TextInput(StringView label, String* str, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* user_data) -> bool {
        ...
        return ImGui::InputText(label.data(), (char*)str->c_str(), str->capacity() + 1, flags, InputTextCallback, &cb_user_data);
    }
} // namespace Cobalt::Widgets
